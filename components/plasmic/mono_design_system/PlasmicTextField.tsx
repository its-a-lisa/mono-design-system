...
import TextInput from "../../TextInput"; // plasmic-import: 44LT2WxFxZIB/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: h_aszYYWpDCJ/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: vNMNcpuWRGZX/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__g5TT, {
          [sty.freeBoxiconEnd__g5TTQbQYn]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__g5TTo6F4T]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__g5TThKAl3]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__aagUf, {
            [sty.freeBoxiconStart__aagUfo6F4T]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__aagUfhKAl3]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__cmFFv)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aWUyM, {
            [sty.freeBoxiconEnd__aWUyMQbQYn]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__aWUyMo6F4T]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__mkLdu)}
                role={"img"}
              />
            ),
