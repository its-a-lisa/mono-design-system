...
import Button from "../../Button"; // plasmic-import: 2IxPeW0JditQ/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: _jyknX0zH48c/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_xMpx0TlQF794"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__c1Kqb)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cLKu)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__b0KEh)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__q4OYu)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
