...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: ql9IYmtNtDfl/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: BecLS-M8RYhg/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: wver1YQz4OLi/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__lr80O)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__xbgmx)}
            role={"img"}
          />
        ) : null}
      </div>
