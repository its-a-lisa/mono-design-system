...
import Radio from "../../Radio"; // plasmic-import: bB7cEMjsgsPp/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: PAB_B76FG-LC/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__vukA6)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__vr8Pr)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__u2Vfd)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__popx0)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
