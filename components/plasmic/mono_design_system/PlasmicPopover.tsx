...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: bZnTzDcJ2ETj/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: ARheOz-lUUjb/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__hdXmu)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__oYvm)}
            label={"Open Popover"}
          />
        ),
