...
import MenuPopover from "../../MenuPopover"; // plasmic-import: Hcyhc9l5RSQz/component
import MenuItem from "../../MenuItem"; // plasmic-import: H0S2MzI8t99y/component
import MenuSection from "../../MenuSection"; // plasmic-import: 0FbMl54tQ-eT/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: UBKOiXE3HQ-C/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__lQx4V)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
