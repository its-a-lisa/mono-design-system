...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: bB7cEMjsgsPp/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ngMhR)}>
        <div className={classNames(projectcss.all, sty.freeBox__rKaY6)} />
      </div>
      {renderPlasmicSlot({
