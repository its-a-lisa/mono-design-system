...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: H0S2MzI8t99y/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__l49Oo)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__a5REi)}>
            <div
              className={classNames(
                projectcss.all,
