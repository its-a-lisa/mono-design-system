...
import SliderThumb from "../../SliderThumb"; // plasmic-import: x58JlwIPhHYS/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: Y_-_oxoc4oQi/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__gKahE)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___8TNrr)}>
        <div
